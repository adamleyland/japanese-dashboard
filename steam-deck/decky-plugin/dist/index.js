const manifest = {"name":"Japanese Dashboard Achievements"};
const API_VERSION = 2;
...
const _global_SP_REACTDOM = SP_REACTDOM;
...
function requireReactDomClient_production () {
	...
	var Scheduler = requireScheduler(),
	  React = _global_SP_REACT,
	  ReactDOM = _global_SP_REACTDOM;
	            ...
	            if (null === current) {
	              ...
	              try {
	                ...
	                hoistableRoot
	                  ...
	                  : hideOrUnhideDehydratedBoundary(wasHidden.stateNode, false);
	              } catch (error) {
	                captureCommitPhaseError(wasHidden, wasHidden.return, error);
	              }
	            }
...
const testNotification = callable("test_notification");
...
function AchievementOverlay() {
    ...
    SP_REACT.useEffect(() => {
        const subscriber = (event) => setQueue((items) => [...items, event]);
    ...
    return SP_REACTDOM.createPortal(SP_JSX.jsxs("div", { className: `jp-achievement-toast ${visible ? "jp-show" : "jp-hide"}`, children: [SP_JSX.jsx("style", { children: `
      ...
      ` }), SP_JSX.jsx("div", { className: "jp-icon", children: current.iconUrl ? SP_JSX.jsx("img", { src: current.iconUrl }) : SP_JSX.jsx(FaTrophy, { className: "jp-lock" }) }), SP_JSX.jsxs("div", { className: "jp-copy", children: [SP_JSX.jsx("div", { className: "jp-label", children: "Achievement unlocked" }), SP_JSX.jsx("div", { className: "jp-name", children: current.achievementName || "Achievement unlocked" }), SP_JSX.jsx("div", { className: "jp-game", children: current.gameTitle || "Non-Steam game" })] }), SP_JSX.jsx("div", { className: "jp-rarity", children: Number.isFinite(rarity) ? `${rarity.toFixed(1)}% players` : "" })] }), document.body);
}
function Content() {
    return SP_JSX.jsx(DFL.PanelSection, { title: "Notifications", children: SP_JSX.jsx(DFL.PanelSectionRow, { children: SP_JSX.jsx(DFL.ButtonItem, { layout: "below", onClick: () => testNotification(), children: "Show test notification" }) }) });
}
var index = definePlugin(() => {
    const overlayHost = document.createElement("div");
    overlayHost.id = "japanese-dashboard-achievement-overlay";
    document.body.appendChild(overlayHost);
    const overlayRoot = clientExports.createRoot(overlayHost);
    overlayRoot.render(SP_JSX.jsx(AchievementOverlay, {}));
    const listener = addEventListener("achievement_unlocked", (event) => subscribers.forEach((subscriber) => subscriber(event)));
    return {
