...
export function isIncludedGame(game) {
  // Local-game records are retained for the hidden companion integration, but
  // must never contribute to any visible gaming totals.
  return game?.source !== "local" && game?.includeInOverallTotal !== false;
}
