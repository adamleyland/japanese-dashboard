...
export function normalizeXboxGame(game = {}) {
  ...
  return {
    ...
    sourceGameId,
    title,
    portraitArtworkUrl: toSafeString(game.portraitArtworkUrl) || pickXboxArtwork(game),
    artworkUrl: pickXboxArtwork(game),
    headerArtworkUrl: pickXboxArtwork(game),
    iconArtworkUrl: toSafeString(game.iconUrl) || pickXboxArtwork(game),
